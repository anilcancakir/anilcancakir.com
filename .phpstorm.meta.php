...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/anilcan/Code/anilcancakir.com/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/anilcan/Code/anilcancakir.com/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'seotools.meta.defaults.title','seotools.meta.defaults.titleBefore','seotools.meta.defaults.description','seotools.meta.defaults.separator','seotools.meta.defaults.keywords',
'seotools.meta.defaults.canonical','seotools.meta.defaults.robots','seotools.meta.webmaster_tags.google','seotools.meta.webmaster_tags.bing','seotools.meta.webmaster_tags.alexa',
'seotools.meta.webmaster_tags.pinterest','seotools.meta.webmaster_tags.yandex','seotools.meta.webmaster_tags.norton','seotools.meta.add_notranslate_class','seotools.opengraph.defaults.title',
'seotools.opengraph.defaults.description','seotools.opengraph.defaults.url','seotools.opengraph.defaults.type','seotools.opengraph.defaults.site_name','seotools.opengraph.defaults.images',
'seotools.twitter.defaults','seotools.json-ld.defaults.title','seotools.json-ld.defaults.description','seotools.json-ld.defaults.url','seotools.json-ld.defaults.type',
'seotools.json-ld.defaults.images','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
...
'web','api',);
        registerArgumentsSet('routes', 'home','storage.local',);
        registerArgumentsSet('views', 
'home','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
